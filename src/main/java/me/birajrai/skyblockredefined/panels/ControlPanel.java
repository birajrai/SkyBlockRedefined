...
import me.birajrai.skyblockredefined.events.MiniShopEvent;
import me.birajrai.skyblockredefined.events.MiniShopEvent.TransactionType;
...
public class ControlPanel implements Listener {
     ...
     */
    public ControlPanel(SkyBlockRedefined plugin) {
        this.plugin = plugin;
    ...
    public static void loadShop() {
        ...
        SkyBlockRedefined plugin = SkyBlockRedefined.getPlugin();
        if (items != null) {
            // Create the store
