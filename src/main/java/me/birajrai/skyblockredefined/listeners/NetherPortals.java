...
import me.birajrai.skyblockredefined.GridManager;
...
import me.birajrai.skyblockredefined.events.IslandEnterEvent;
...
public class NetherPortals implements Listener {
    ...
    public NetherPortals(SkyBlockRedefined plugin) {
        this.plugin = plugin;
    }
    ...
    public void onEntityPortal(final EntityPortalEvent event) {
        ...
        if (!Settings.createNether || SkyBlockRedefined.getNetherWorld() == null) {
            if (DEBUG)
                plugin.getLogger().info("DEBUG: Disabled nether: Settings create nether = " + Settings.createNether + " " + (SkyBlockRedefined.getNetherWorld() == null ? "Nether world is null": "Nether world is not null"));
            return;
        }
    ...
    public void onPlayerPortal(final PlayerPortalEvent event) {
        ...
        case NETHER_PORTAL:
            ...
            World homeWorld = SkyBlockRedefined.getIslandWorld();
            ...
            if (!Settings.newNether) {
                ...
                if (event.getFrom().getWorld().getEnvironment().equals(Environment.NORMAL)) {
                    ...
                    if (homeWorld.getEnvironment().equals(Environment.NORMAL)) {
                        ...
                        event.setTo(SkyBlockRedefined.getNetherWorld().getSpawnLocation());
                    ...
                    if (homeWorld.getEnvironment().equals(Environment.NORMAL)) {
                        ...
                        event.setTo(SkyBlockRedefined.getIslandWorld().getSpawnLocation());
                        event.useTravelAgent(true); 
                    }
                }
            } else {
                ...
                Location overworldIsland = island.getCenter().toVector().toLocation(SkyBlockRedefined.getIslandWorld());
                Location netherIsland = island.getCenter().toVector().toLocation(SkyBlockRedefined.getNetherWorld());
                ...
                if (event.getFrom().getWorld().getEnvironment().equals(Environment.NORMAL)) {
                    ...
                    if (DEBUG)
                        plugin.getLogger().info("DEBUG: Teleporting to " + event.getFrom().toVector().toLocation(SkyBlockRedefined.getNetherWorld()));
                    event.setCancelled(true);
