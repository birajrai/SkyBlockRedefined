...
import me.birajrai.skyblockredefined.events.IslandExitEvent;
...
public class IslandGuard implements Listener {
    ...
    public IslandGuard(final SkyBlockRedefined plugin) {
        this.plugin = plugin;
    ...
    protected static boolean inWorld(World world) {
        ...
        return Settings.createNether && Settings.newNether && SkyBlockRedefined.getNetherWorld() != null
                && world.equals(SkyBlockRedefined.getNetherWorld());
    }
    /**
            ...
            if (e.getMaterial() == Material.WOOD_DOOR || e.getMaterial() == Material.CHEST
                ...
                try {
                    ...
                    if (p.isSplash()) {
                        ...
                        boolean inNether = false;
                        if (e.getPlayer().getWorld().equals(SkyBlockRedefined.getNetherWorld())) {
                            inNether = true;
                        }
                        // Check PVP
                        if (island == null) {
    ...
    public void onCraft(CraftItemEvent event) {
        ...
        if (inWorld(player) || player.getWorld().equals(SkyBlockRedefined.getNetherWorld())) {
    ...
    public void onSplashPotionSplash(final PotionSplashEvent e) {
        ...
        if (projectile.getShooter() != null && projectile.getShooter() instanceof Player) {
            ...
            for (LivingEntity entity: e.getAffectedEntities()) {
                ...
                boolean inNether = false;
                if (entity.getWorld().equals(SkyBlockRedefined.getNetherWorld())) {
                    inNether = true;
                }
                // Monsters being hurt
