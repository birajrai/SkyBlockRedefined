...
public class Island {
     ...
     * @param settingsKey
     */
    public Island(SkyBlockRedefined plugin, String serial, List<String> settingsKey) {
        this.plugin = plugin;
        ...
        try {
            ...
            this.world = SkyBlockRedefined.getIslandWorld();
     ...
     * @param z
     */
    public Island(SkyBlockRedefined plugin, int x, int z) {
        this(plugin, x, z, null);
    }

    public Island(SkyBlockRedefined plugin, int x, int z, UUID owner) {
        this.plugin = plugin;
    ...
    public boolean onIsland(Location target) {
        if (world != null) {
            ...
            if (target.getWorld().equals(world) || (Settings.createNether && Settings.newNether && SkyBlockRedefined.getNetherWorld() != null && target.getWorld().equals(SkyBlockRedefined.getNetherWorld()))) {
    ...
    public boolean inIslandSpace(Location target) {
        if (target.getWorld().equals(SkyBlockRedefined.getIslandWorld()) || target.getWorld().equals(SkyBlockRedefined.getNetherWorld())) {
    ...
    public List<UUID> getMembers() {
        ...
        result.addAll(CoopPlay.getInstance().getCoopPlayers(center.toVector().toLocation(SkyBlockRedefined.getIslandWorld())));
        if (Settings.createNether && Settings.newNether && SkyBlockRedefined.getNetherWorld() != null) {
            result.addAll(CoopPlay.getInstance().getCoopPlayers(center.toVector().toLocation(SkyBlockRedefined.getNetherWorld())));
        }
        if (owner == null) {
            return result;
        }
