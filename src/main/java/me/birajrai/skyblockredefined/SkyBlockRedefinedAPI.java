 ...
 * @author tastybento
 */
public class SkyBlockRedefinedAPI {
    private static SkyBlockRedefinedAPI instance;

    /**
     * @return the instance
     */
    public static SkyBlockRedefinedAPI getInstance() {
        if (instance == null)
            // Initialize the API
            new SkyBlockRedefinedAPI(SkyBlockRedefined.getPlugin());
        return instance;
    }
    ...
    protected SkyBlockRedefinedAPI(SkyBlockRedefined plugin) {
        this.plugin = plugin;
        instance = this;
    }
    ...
    public World getIslandWorld() {
        return SkyBlockRedefined.getIslandWorld();
    }
    ...
    public World getNetherWorld() {
        return SkyBlockRedefined.getNetherWorld();
    }
