...
public class Locale {
    ...
    private java.util.Locale localeObject;
     ...
     */
    public Locale(SkyBlockRedefined plugin, String localeName, int index) {
        this.plugin = plugin;
        this.index = index;
        ...
        localeObject = new java.util.Locale(localeName.substring(0, 2), localeName.substring(3, 5));
        //}       
    }
