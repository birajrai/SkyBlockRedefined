...
import me.birajrai.skyblockredefined.events.CoopJoinEvent;
import me.birajrai.skyblockredefined.events.CoopLeaveEvent;
...
public class CoopPlay {
    private static CoopPlay instance = new CoopPlay(SkyBlockRedefined.getPlugin());
     ...
     */
    private CoopPlay(SkyBlockRedefined plugin) {
        this.plugin = plugin;
    }
