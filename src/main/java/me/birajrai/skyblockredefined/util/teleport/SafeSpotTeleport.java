package me.birajrai.skyblockredefined.util.teleport;
...
public class SafeSpotTeleport {
     ...
     * @param homeNumber
     */
    protected SafeSpotTeleport(SkyBlockRedefined plugin, final Entity entity, final Location location, final String failureMessage, boolean portal,
                               int homeNumber) {
        this.plugin = plugin;
        this.entity = entity;
