...
public class VaultHelper {
    ...
    public static boolean setupEconomy() {
        RegisteredServiceProvider<Economy> economyProvider = SkyBlockRedefined.getPlugin().getServer().getServicesManager()
    ...
    public static boolean setupPermissions() {
        RegisteredServiceProvider<Permission> permissionProvider = SkyBlockRedefined.getPlugin().getServer().getServicesManager()
